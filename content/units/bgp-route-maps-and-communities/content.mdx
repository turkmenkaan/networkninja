...
<ASTopology
  ...
  nodes={[
    { id: "r1", name: "r1", asn: "AS 65001", sublabel: "originates + tags", col: 0, row: 0 },
    { id: "r2", name: "r2", asn: "AS 65002", sublabel: "transit, acts on tag", col: 1, row: 0 },
    { id: "r3", name: "r3", asn: "AS 65003", sublabel: "far observer", col: 2, row: 0 },
  ]}
  links={[
    { from: "r1", to: "r2" },
    { from: "r2", to: "r3" },
