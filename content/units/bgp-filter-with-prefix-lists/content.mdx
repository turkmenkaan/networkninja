...
<ASTopology
  ...
  nodes={[
    { id: "r1", name: "r1", asn: "AS 65001", sublabel: ["customer", "lo 1.1.1.1/32", "eth1 10.0.12.1/24"], col: 0, row: 0 },
    { id: "r2", name: "r2", asn: "AS 65002", sublabel: ["your filter", "lo 2.2.2.2/32", "eth1 10.0.12.2/24"], col: 1, row: 0 },
  ]}
  links={[{ from: "r1", to: "r2" }]}
