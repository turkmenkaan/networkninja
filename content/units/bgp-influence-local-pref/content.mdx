...
<ASTopology
  ...
  nodes={[
    { id: "r2", name: "r2", asn: "AS 65002", sublabel: ["upstream A, adv 100.64.0.0/24", "lo 2.2.2.2/32", "eth1 10.0.12.2/24"], col: 0, row: 0 },
    { id: "r1", name: "r1", asn: "AS 65001", sublabel: ["lo 1.1.1.1/32 (your AS)", "eth1 10.0.12.1/24", "eth2 10.0.13.1/24"], col: 1, row: 0 },
    { id: "r3", name: "r3", asn: "AS 65003", sublabel: ["upstream B, adv 100.64.0.0/24", "lo 3.3.3.3/32", "eth1 10.0.13.3/24"], col: 2, row: 0 },
  ]}
  links={[
    { from: "r2", to: "r1" },
    { from: "r1", to: "r3" },
