...
<ASTopology
  ...
  nodeShape="router"
  nodes={[
    { id: "ext1", name: "ISP A", sublabel: "external", col: 0, row: 1, muted: true },
    { id: "e1", name: "edge1", sublabel: "eBGP edge", col: 1, row: 1 },
    { id: "core", name: "core", sublabel: "internal", col: 2, row: 0 },
    { id: "e2", name: "edge2", sublabel: "eBGP edge", col: 3, row: 1 },
    { id: "ext2", name: "ISP B", sublabel: "external", col: 4, row: 1, muted: true },
  ]}
  links={[
  ...
  groups={[
    { nodes: ["ext1"], label: "AS 64500" },
    { nodes: ["e1", "core", "e2"], label: "AS 65000" },
    { nodes: ["ext2"], label: "AS 64600" },
  ]}
