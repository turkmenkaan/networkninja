...
<ASTopology
  ...
  nodes={[
    { id: "r1", name: "r1", sublabel: ["lo 1.1.1.1/32", "eth1 10.0.12.1/24"], col: 0, row: 0 },
    { id: "r2", name: "r2", sublabel: ["lo 2.2.2.2/32", "eth1 10.0.12.2/24"], col: 1, row: 0 },
  ]}
  links={[{ from: "r1", to: "r2" }]}
  groups={[{ nodes: ["r1", "r2"], label: "AS 65001" }]}
