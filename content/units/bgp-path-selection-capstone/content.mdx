...
<ASTopology
  ...
  nodes={[
    { id: "r1", name: "r1", asn: "AS 65001", sublabel: "your edge - lo 1.1.1.1/32", col: 1, row: 0 },
    { id: "r2", name: "r2", asn: "AS 65002", sublabel: "upstream A - PRIMARY", col: 0, row: 1 },
    { id: "r3", name: "r3", asn: "AS 65003", sublabel: "upstream B - BACKUP", col: 2, row: 1 },
    { id: "r4", name: "r4", asn: "AS 65004", sublabel: "internet - originates 100.64.0.0/24", col: 1, row: 2 },
  ]}
  links={[
