...
<ASTopology
  ...
  nodeShape="router"
  nodes={[
    { id: "r4", name: "r4", asn: "AS 65001", sublabel: ["lo 4.4.4.4/32", "eth1 10.0.14.4/24"], col: 0, row: 0 },
    { id: "r1", name: "r1", asn: "AS 65000", sublabel: ["edge", "lo 1.1.1.1/32", "eth1 10.0.14.1/24", "eth2 10.0.12.1/24"], col: 1, row: 0 },
    { id: "r2", name: "r2", asn: "AS 65000", sublabel: ["core", "lo 2.2.2.2/32", "eth1 10.0.12.2/24", "eth2 10.0.23.2/24"], col: 2, row: 0 },
    { id: "r3", name: "r3", asn: "AS 65000", sublabel: ["edge", "lo 3.3.3.3/32", "eth1 10.0.23.3/24", "eth2 10.0.35.3/24"], col: 3, row: 0 },
    { id: "r5", name: "r5", asn: "AS 65002", sublabel: ["lo 5.5.5.5/32", "eth1 10.0.35.5/24"], col: 4, row: 0 },
  ]}
  links={[
