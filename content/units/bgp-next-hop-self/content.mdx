...
<ASTopology
  ...
  nodes={[
    { id: "r2", name: "r2", sublabel: ["lo 2.2.2.2/32", "eth1 10.0.12.2/24"], col: 0, row: 0 },
    { id: "r1", name: "r1", sublabel: ["lo 1.1.1.1/32", "eth1 10.0.12.1/24", "eth2 10.0.13.1/24"], col: 1, row: 0 },
    { id: "r3", name: "r3", sublabel: ["lo 3.3.3.3/32", "eth1 10.0.13.3/24"], col: 2, row: 0 },
  ]}
  links={[
    { from: "r2", to: "r1" },
